...
import cryptoAnalyzer.render.*;

public class MainUIProxy extends JFrame implements ActionListener{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	private static MainUIProxy instance;
	...
	public static MainUIProxy getInstance() {
		if (instance == null)
			instance = new MainUIProxy();
